...
const QuizHeader = ({ menu_items }) => {
    ...
    return (
        <header className="bg-primary flex flex-col justify-start items-start lg:flex-row lg:justify-start px-4 py-2 gap-3 lg:gap-8  antialiased shadow-2xl">
            <div className="flex gap-2 w-full lg:w-fit">
                ...
                {/* brand name */}
                <a href="/" className="flex-1 text-center lg:text-left text-secondary font-bold"><span className="text-xl font-extrabold">{import.meta.env.VITE_APP_NAME}</span></a>
                {/* side menu */}
            ...
            {/* menu items */}
            <nav className={`hidden md:flex justify-start lg:justify-end items-center flex-wrap gap-2 text-[14px] md:text-[16px] md:gap-4 text-sm  text-menu`}>
            ...
            {/* mobile menu*/}
            <aside className={`${toggleMobileMenu ? "flex" : "hidden"} flex-col justify-start items-start overflow-y-hidden bg-slate-700 text-white gap-4 fixed top-0 left-0 z-50 h-screen w-full`} >
                {/* close icon */}
            ...
            {/* left bar */}
            <aside className={`${toggleMobileSideBar ? "flex" : "hidden"} flex-col justify-start items-start overflow-y-hidden bg-slate-700 text-white gap-4 fixed top-0 left-0 z-50 h-screen w-full`} >
                {/* close icon */}
