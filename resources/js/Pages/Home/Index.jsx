    ...
    return (
        <>
                        ...
                        if (view.level == 2) {
                            ...
                            if (view.mainItemType == 'two_columns_tabular_view_level_2') {
                                return (
                                    <>
                                        <h2 className="text-lg font-semibold text-center w-full pt-5">{isCategory == 0 ? view.mainItemName : title}</h2>
                                        <div key={view.sid} className="flex justify-center items-center w-full lg:max-w-[98%] gap-4">
                                    ...
                                    <div className="p-2 w-full flex flex-wrap gap-4">
                                        {
                                            view.subItems.map((subitem) => {
                                                ...
                                                return (
                                                    <div className="w-full md:w-fit shadow-lg flex justify-start items-center border py-3 px-3 rounded gap-3 hover:border-black">
                                                        <div>
                                                        <svg
                                                            fill="#0000000"
                                                            version="1.1"
			...
			H294.442L294.442,388.15z"
                                                        ...
                                                        <a href={`/quiz/${subitem?.sid}${contentType ? `/${contentType}` : ""}`} key={subitem.sid} className="underline text-blue-700 pr-3">{subitem.text1st}</a>
                                                    </div>
                                                )
                                            })
                                        }
