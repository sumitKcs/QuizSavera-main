...
export default function PrivacyPolicy({cat_name, cat_id}) {

    return (

        <AppLayout title={'Privacy Policy'} description={'Privacy Policy for Quiz Savera'} keywords={'Privacy Policy for Quiz Savera'} leftBar={true} rightBar={false} carousel={false}>
            <div className="py-4 flex flex-col gap-4 w-full rounded">
                <h1 className="bg-secondary text-extrabold text-center text-xl py-1">Privacy Policy for Quiz Savera</h1>
                {/* Privacy Policy */}
                <div className="flex flex-col gap-4 py-2">
                    <h2 className=" text-orange-400 font-extrabold text-lg">Privacy Policy</h2>
                ...
                <div className="flex flex-col gap-4 py-2">
                    <h2 className=" text-orange-400 font-extrabold text-lg">Interpretation and Definitions</h2>
                    {/* Interpretation */}
                    <h3 className=" text-orange-400 font-extrabold text-md">Interpretation</h3>
                    <div className="flex flex-col gap-2">
                        <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                    </div>
                    {/* Definitions  */}
                    <h3 className=" text-orange-400 font-extrabold text-md">Definitions</h3>
                    <div className="flex flex-col gap-2">
                        ...
                        <ul className="flex flex-col gap-2 list-disc pl-8">
                            ...
                            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Quiz Savera.</li>
                            ...
                            <li><strong>Website</strong> refers to Quiz Savera, accessible from <a href="https://quizsavera.com" target="_blank" className="text-blue-600 font-extrabold">https://quizsavera.com</a></li>
                ...
                <div className="flex flex-col gap-4 py-2">
                    <h2 className=" text-orange-400 font-extrabold text-lg">Collecting and Using Your Personal Data</h2>
                    {/* Types of Data Collected */}
                    <h3 className=" text-orange-400 font-extrabold text-md">Types of Data Collected</h3>
                    <h3 className="text-orange-400 font-extrabold text-md">Personal Data</h3>
                    <div className="flex flex-col gap-2">
                    ...
                    {/* Definitions  */}
                    <h3 className=" text-orange-400 font-extrabold text-md">Usage Data</h3>
                    <div className="flex flex-col gap-2">
                        ...
                        <h3 className=" text-orange-400 font-extrabold text-md">Tracking Technologies and Cookies</h3>
                    ...
                    <h3 className=" text-orange-400 font-extrabold text-lg">Use of Your Personal Data</h3>
                    ...
                    <h3  className=" text-orange-400 font-extrabold text-md">Retention of Your Personal Data</h3>
                    ...
                    <h3  className=" text-orange-400 font-extrabold text-md">Transfer of Your Personal Data</h3>
                    ...
                    <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.</p>
                     ...
                     <h3  className=" text-orange-400 font-extrabold text-md">Delete Your Personal Data</h3>
                    ...
                    <h3  className=" text-orange-400 font-extrabold text-md">Disclosure of Your Personal Data</h3>
                    <h4  className=" text-orange-400 font-extrabold text-md">Business Transactions</h4>
                    <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                    <h4  className=" text-orange-400 font-extrabold text-md">Law enforcement</h4>
                    <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                    <h4  className=" text-orange-400 font-extrabold text-md">Other legal requirements</h4>
                    ...
                    <h4  className=" text-orange-400 font-extrabold text-md">Security of Your Personal Data</h4>
                    <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                    {/* Children's Privacy */}
                    <h2 className="text-orange-400 font-extrabold text-lg">Children's Privacy</h2>
                    ...
                    <h2 className="text-orange-400 font-extrabold text-lg">Links to Other Websites</h2>
                    <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                    <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                    {/* Changes to this Privacy Policy */}
                    <h2 className="text-orange-400 font-extrabold text-lg">Changes to this Privacy Policy</h2>
                    <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
                    <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
                    <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
                    {/* Contact Us */}
                    <h2 className="text-orange-400 font-extrabold text-lg">Contact Us</h2>
                    <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                    <ul className="flex flex-col gap-2 list-disc pl-8">
                        <li>
                            By email: support@quizsavera.com
                        </li>
                        <li>
                            By visiting this page on our website: <a href="https://quizsavera.com/contact" className="text-blue-600 font-extrabold" target="_blank">https://quizsavera.com/contact</a>
                        </li>
                    </ul>
                </div>
            </div>
